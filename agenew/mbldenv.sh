...
PATH=/usr/lib/jvm/java-8-openjdk-amd64/bin:$PWD/prebuilts/gcc/linux-x86/arm/cit-arm-linux-androideabi-4.8/bin:$PWD/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin:$PWD/prebuilts/gcc/linux-x86/aarch64/linaro-aarch64-linux-gnu-4.8/bin:$PWD/prebuilts/misc/linux-x86/make:$PATH
export PATH
