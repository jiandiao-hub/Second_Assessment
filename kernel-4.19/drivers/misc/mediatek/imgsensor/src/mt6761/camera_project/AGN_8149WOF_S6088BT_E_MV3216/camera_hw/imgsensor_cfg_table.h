...
#define IMGSENSOR_HW_POWER_INFO_MAX	17//12
...
#define AF_EN  IMGSENSOR_HW_PIN_AF_EN //wdong //log: sensor_idx = 0/1, pin=7(enum IMGSENSOR_HW_PIN{}), ..., printed by imgsensor_hw_power_sequence() function
