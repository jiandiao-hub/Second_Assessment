...
int get_sensor_luminance_value_gc2385(kal_uint16 *luma )
{
  GC0310_write_cmos_sensor(0xfe,0x00);
	*luma = GC0310_read_cmos_sensor(0xef);

	pr_err("mycat get_sensor_luminance_value_gc2385:: %d\n", *luma);
...
static void GC0310_Sensor_Init(void)
{
	...
	GC0310_write_cmos_sensor(0x01,0x03);             
	GC0310_write_cmos_sensor(0x02,0x11); //00  travis          
    ...
    GC0310_write_cmos_sensor(0xd1,0x36); 
    GC0310_write_cmos_sensor(0xd2,0x36); 
...
*/
	...
	GC0310_write_cmos_sensor(0x2b,0x08); //10fps
	GC0310_write_cmos_sensor(0x2c,0x6c); 
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    kal_uint8 retry = 2;
#ifdef CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT
		fake_dualsensor_id=((GC0310_read_cmos_sensor(0xf0)<< 8)|GC0310_read_cmos_sensor(0xf1));
		LOG_INF("mycat gc0310_sensorid sensor id: 0x%x\n", fake_dualsensor_id);
#endif
...
#ifdef CONFIG_BIRD_FAKE_DUAL_CAM_SUPPORT
		fake_dualsensor_id=((GC0310_read_cmos_sensor(0xf0)<< 8)|GC0310_read_cmos_sensor(0xf1));
		LOG_INF("mycat gc0310_open sensor id: 0x%x\n", fake_dualsensor_id);
#endif
