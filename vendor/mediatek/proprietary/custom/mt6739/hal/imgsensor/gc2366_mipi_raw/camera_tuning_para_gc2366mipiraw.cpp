...
#include "AE_Tuning_Para/camera_ae_tuning_para_gc2366mipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_VIDEO>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAENVRAM_gc2366mipiraw<CAM_SCENARIO_CUSTOM4>()
    },
