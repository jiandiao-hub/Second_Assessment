...
STATIC_METADATA2_BEGIN(PROJECT, SCALER, SENSOR_DRVNAME_GC5035MIPI_RAW)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)//new hidden
				...
				CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //2mp 18:9
                CONFIG_ENTRY_VALUE(1920, MINT32)
                ...
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
	            CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //2mp 18:9
                CONFIG_ENTRY_VALUE(1560, MINT32)
                CONFIG_ENTRY_VALUE(720, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)	
				CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //2mp 18:9
				...
				CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //2mp 18:9
                CONFIG_ENTRY_VALUE(2016, MINT32)
                CONFIG_ENTRY_VALUE(1008, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
				...
				CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64)//2mp 18:9
                CONFIG_ENTRY_VALUE(2016, MINT64)
                CONFIG_ENTRY_VALUE(1008, MINT64)
                CONFIG_ENTRY_VALUE(33333333, MINT64)
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_JPEG_MAX_SIZE)//
        CONFIG_ENTRY_VALUE(6046618, MINT32) //2560*1920*2*0.6   //3840x2160x2x0.6  9953280
    CONFIG_METADATA_END()
    //==========================================================================
