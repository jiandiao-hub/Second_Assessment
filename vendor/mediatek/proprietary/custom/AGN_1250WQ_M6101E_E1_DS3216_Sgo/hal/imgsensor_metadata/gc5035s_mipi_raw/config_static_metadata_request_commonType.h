...
STATIC_METADATA2_BEGIN(PROJECT, REQUEST, SENSOR_DRVNAME_GC5035SMIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_SCALER_CROP_APP_REGION, MINT32)
		CONFIG_ENTRY_VALUE(MTK_CONTROL_ZOOM_RATIO, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
		...
		CONFIG_ENTRY_VALUE(MTK_CONTROL_ZOOM_RATIO_RANGE, MINT32)
