...
STATIC_METADATA2_BEGIN(PROJECT, SENSOR, SENSOR_DRVNAME_GC5035SMIPI_RAW)
//------------------------------------------------------------------------------
//  android.sensor
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_SENSITIVITY_RANGE)
        CONFIG_ENTRY_VALUE(100L, MINT32)
        CONFIG_ENTRY_VALUE(1600L, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_SENSOR_INFO_EXPOSURE_TIME_RANGE)// 1 us - 30 sec
        CONFIG_ENTRY_VALUE(33000L, MINT64)
        CONFIG_ENTRY_VALUE(120000000L, MINT64)
    CONFIG_METADATA_END()
    //==========================================================================
