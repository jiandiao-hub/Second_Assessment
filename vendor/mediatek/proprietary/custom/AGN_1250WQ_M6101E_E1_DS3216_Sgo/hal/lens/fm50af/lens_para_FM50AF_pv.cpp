...
#include "lens_para_FM50AF.h"


template <>
NVRAM_LENS_DATA_PARA_STRUCT const&
GET_FM50AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
{
    static NVRAM_LENS_DATA_PARA_STRUCT FM50AF_LENS_PARA_DEFAULT_VALUE =
    {
        // File Path
        {
            __FILE__
		...
		20,  // i4PostureComp;            //[6] post comp max offset => 0:disable, others:enable
    ...
    return FM50AF_LENS_PARA_DEFAULT_VALUE;
}
