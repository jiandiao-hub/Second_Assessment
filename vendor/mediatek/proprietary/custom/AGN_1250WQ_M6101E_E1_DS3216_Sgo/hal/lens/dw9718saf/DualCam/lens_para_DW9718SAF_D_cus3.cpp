...
GET_DW9718SAF_D_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>() // binning-size vdo record
{
    static NVRAM_LENS_DATA_PARA_STRUCT DW9718SAF_D_LENS_PARA_DEFAULT_VALUE =
    {
        // File Path
        {
            __FILE__
    ...
    return DW9718SAF_D_LENS_PARA_DEFAULT_VALUE;
}
