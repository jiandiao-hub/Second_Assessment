...
STATIC_METADATA2_BEGIN(PLATFORM, LENS, SENSOR_DRVNAME_GC5035MIPI_RAW)
//------------------------------------------------------------------------------
//  android.lens.info
//------------------------------------------------------------------------------
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_INFO_AVAILABLE_FOCAL_LENGTHS)
        CONFIG_ENTRY_VALUE(2.5f, MFLOAT)
    CONFIG_METADATA_END()
   ...
   // CONFIG_METADATA_END()
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_INFO_MINIMUM_FOCUS_DISTANCE)
        CONFIG_ENTRY_VALUE((1.0/0.10), MFLOAT)    // 10 cm min focus distance
    CONFIG_METADATA_END()
    //==========================================================================
