...
STATIC_METADATA2_BEGIN(PLATFORM, AVAILABLE_KEYS, SENSOR_DRVNAME_GC8034_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        // wide camera
        APPEND_ENTRY_VALUE(TRAN_WIDE_MODE, MINT32)
        APPEND_ENTRY_VALUE(TRAN_WIDE_MODE_AVAIL, MINT32)
	#endif
    APPEND_METADATA_END()
    //==========================================================================
