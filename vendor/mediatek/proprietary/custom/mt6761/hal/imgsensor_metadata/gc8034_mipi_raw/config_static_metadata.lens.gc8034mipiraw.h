...
STATIC_METADATA2_BEGIN(PLATFORM, LENS, SENSOR_DRVNAME_GC8034_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.lens.info
//------------------------------------------------------------------------------
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_INFO_AVAILABLE_APERTURES)
#if defined(GC8034_17201483) ||defined(GC8034_17201521)
        CONFIG_ENTRY_VALUE(2.0f, MFLOAT)
#elif defined(GC8034_17201535)
...
#if defined(GC8034_17201483) ||defined(GC8034_17201521)
        CONFIG_ENTRY_VALUE(2.83f, MFLOAT)
#elif defined(GC8034_17201535)
