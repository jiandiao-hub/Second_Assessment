...
#include "camera_AE_PLineTable_gc2375hmipiraw.h"
#include "camera_info_gc2375hmipiraw.h"
#include "camera_custom_AEPlinetable.h"
#include "camera_custom_tsf_tbl.h"
#include "AE_Tuning_Para/camera_ae_tuning_para_gc2375hmipiraw.h"
#include "AWB_Tuning_Para/camera_awb_tuning_para_gc2375hmipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_PREVIEW>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_VIDEO>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_CAPTURE>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAENVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM4>()
    },

        // AWB NVRAM
    AWB_NVRAM_START
    {
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_PREVIEW>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_VIDEO>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_CAPTURE>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAWBNVRAM_gc2375hmipiraw<CAM_SCENARIO_CUSTOM4>()
                    },
