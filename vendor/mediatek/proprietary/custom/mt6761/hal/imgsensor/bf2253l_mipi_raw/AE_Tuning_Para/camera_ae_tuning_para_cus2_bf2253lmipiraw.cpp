...
#include "camera_ae_tuning_para_bf2253lmipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_bf2253lmipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
