...
#include "camera_ae_tuning_para_ov13b10mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_ov13b10mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        //rMeteringSpec
        {
            ...
            //rABL_Spec
            {
                ...
                300, //256, // final target limitation, 256/128 = 2x
                //sFgBgEVRatio
                {
                    2800,//2200, //i4X1
                    0,    //i4Y1
