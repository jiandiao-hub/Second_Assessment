...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {1228, 378, 707, -369};
    FLICKER_CUST_STATISTICS EV60_L50 = {1464, 398, 1052, -444};
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1357, 430, 1136, -463};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Capture_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1267, 366, 685, -361};
    FLICKER_CUST_STATISTICS EV60_L50 = {1511, 386, 1020, -436};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1419, 411, 1086, -452};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 26;
...
static void get_flicker_para_by_Video1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {284, 1633, 3050, -744};
    FLICKER_CUST_STATISTICS EV60_L50 = {339, 1720, 4541, -818};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {261, 1776, 3318, -765};
    FLICKER_CUST_STATISTICS EV60_L50 = {312, 1871, 4939, -839};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 23;
...
static void get_flicker_para_by_Video2_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {293, 1585, 2960, -736};
    FLICKER_CUST_STATISTICS EV60_L50 = {349, 1669, 4407, -810};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 24;
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {261, 1781, 3326, -766};
    FLICKER_CUST_STATISTICS EV60_L50 = {311, 1875, 4952, -840};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
