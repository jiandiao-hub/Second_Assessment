...
/******************************************************************************/
        // PWB light area
        {
            ...
            // Cloudy daylight
            {
                 360, // PCloudyRightBound
                 185, // PCloudyLeftBound
                -404, // PCloudyUpperBound
                -547  // PCloudyLowerBound
            },
            // Shade
            {
                 460, // PShadeRightBound
                 185, // PShadeLeftBound
                -404, // PShadeUpperBound
            ...
            // Warm fluorescent
            {
                ...
                -347, // PWFluoLeftBound
                -414, // PWFluoUpperBound
                -626  // PWFluoLowerBound
            },
            // Incandescent
            {
                -147, // PIncaRightBound
...
/******************************************************************************/
                // rRefTarget
                {
                     ...
                     {1233,  875},   //rMidCT Unit=1000 for indoor office
...
/******************************************************************************/
                ...
                {  5,  5,  5,  5,  5,  5,  7,  7,  7,  7,  5,  5,  5,  5,  5,  4,  3,  2,  2},
/******************************************************************************/
//Feature name:
...
/******************************************************************************/
                ...
                // rFaceAWBProb2
                {
                     400,    //i4FaceAreaRG_LowTh Unit=1000
