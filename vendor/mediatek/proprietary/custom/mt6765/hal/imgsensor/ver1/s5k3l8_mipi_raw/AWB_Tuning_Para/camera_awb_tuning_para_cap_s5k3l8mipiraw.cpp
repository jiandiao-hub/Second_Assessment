...
#include "camera_awb_tuning_para_s5k3l8mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_s5k3l8mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
...
/******************************************************************************/
        // PWB light area
        {
                ...
                // Cloudy daylight
                {
                    330, // PCloudyRightBound
                    155, // PCloudyLeftBound
                    -418, // PCloudyUpperBound
                    -551  // PCloudyLowerBound
                },
                // Shade
                {
                    430, // PShadeRightBound
                    155, // PShadeLeftBound
                    -418, // PShadeUpperBound
                ...
                // Warm fluorescent
                {
                    ...
                    -380, // PWFluoLeftBound
                    -428, // PWFluoUpperBound
                    -611  // PWFluoLowerBound
                },
                // Incandescent
                {
                    -180, // PIncaRightBound
...
/******************************************************************************/
            ...
            {
                    -602,  // RotatedXCoordinate0
                    -455,  // RotatedXCoordinate1
                    -289,  // RotatedXCoordinate2
                    -145,  // RotatedXCoordinate3
...
/******************************************************************************/
        // Preference gain for each light source
        {
            ...
            { // WF
                ...
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18      
                {502, 512, 512}, {504, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
            },
            { // F
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18      
                {508, 512, 512}, {508, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}
            },
            { // CWF
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
...
/******************************************************************************/
             // Sunset Prop
             {
                 ...
                 {
                         66, // i4Sunset_BoundXr_Thr
                         -492, // i4Sunset_BoundYr_Thr
                 },
             },
/******************************************************************************/
//Feature name:
...
/******************************************************************************/
            ...
            {
                1,    //i4Enable
                    {0, 16, 16, 16, 16, 16, 16, 16},  //i4StatWinShrinkOffset
                0,    //Reserved1
                0,    //Reserved2
                0,    //Reserved3
                0,    //Reserved4
