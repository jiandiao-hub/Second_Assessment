...
#include "camera_awb_tuning_para_ov12a10mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_ov12a10mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
...
/******************************************************************************/
        // AWB gain of AWB light source
        {
            // Strobe	
            {
                    977, // AWBGAIN_STROBE_R
                    512, // AWBGAIN_STROBE_G
                    845 // AWBGAIN_STROBE_B
                },
                // Horizon
                {
                    512, // AWBGAIN_HOR_R
...
/******************************************************************************/
        // AWB light area
        {
            // Strobe
            {
                       126, // StrobeRightBound
                       26, // StrobeLeftBound
                       -371, // StrobeUpperBound
                       -471  // StrobeLowerBound
                },
                // Tungsten
                {
                    -106, // TungRightBound
...
/******************************************************************************/
        // PWB light area
        {
            // Reference area
            {
                ...
                // Cloudy daylight
                {
                    393, // PCloudyRightBound
                    218, // PCloudyLeftBound
                    -327, // PCloudyUpperBound
                    -462  // PCloudyLowerBound
                },
                // Shade
                {
                    493, // PShadeRightBound
                    218, // PShadeLeftBound
...
/******************************************************************************/
            ...
            {
                    -606,  // RotatedXCoordinate0
                    -442,  // RotatedXCoordinate1
...
/******************************************************************************/
        // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
        {
                ...
                {  85, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  75,  50,  40,  30,  20}, // Daylight
