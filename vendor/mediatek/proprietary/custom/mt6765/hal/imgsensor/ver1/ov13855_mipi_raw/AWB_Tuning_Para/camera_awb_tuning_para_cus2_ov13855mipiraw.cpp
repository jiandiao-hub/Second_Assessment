...
#include "camera_awb_tuning_para_ov13855mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_ov13855mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
...
/******************************************************************************/
        ...
        //******************************************************************************//
            // AWB gain of AWB light source
            {
                // Strobe	
                {
                    968, // AWBGAIN_STROBE_R
                    512, // AWBGAIN_STROBE_G
                    826 // AWBGAIN_STROBE_B
                },
                // Horizon
                {
                    512, // AWBGAIN_HOR_R
...
/******************************************************************************/
        // AWB light area
        {
            // Strobe
            {
                       152, // StrobeRightBound
                       52, // StrobeLeftBound
                       -354, // StrobeUpperBound
                       -454  // StrobeLowerBound
                },
                // Tungsten
                {
                    -116, // TungRightBound
...
/******************************************************************************/
        // PWB light area
        {
            // Reference area
            {
                ...
                // Cloudy daylight
                {
                    394, // PCloudyRightBound
                    219, // PCloudyLeftBound
                    -320, // PCloudyUpperBound
                    -446  // PCloudyLowerBound
                },
                // Shade
                {
                    494, // PShadeRightBound
                    219, // PShadeLeftBound
...
/******************************************************************************/
            ...
            {
                    -601,  // RotatedXCoordinate0
                    -459,  // RotatedXCoordinate1
                    -285,  // RotatedXCoordinate2
...
/******************************************************************************/
             // Sunset Prop
             {
                 ...
                 {
                         139, // i4Sunset_BoundXr_Thr
                         -404, // i4Sunset_BoundYr_Thr
                 },
             },
/******************************************************************************/
//Feature name:
