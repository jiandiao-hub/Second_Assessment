...
#include "camera_ae_tuning_para_s5k5e8yxrear2mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_s5k5e8yxrear2mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    // rDevicesInfo
