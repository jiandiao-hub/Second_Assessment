//Gionee <Amigo_Skip> <fangrui> <20170228> SW17G04 Rear Main Camera S5K2P7 Tuning begin
/* Copyright Statement:
*
...
#include "camera_ae_tuning_para_s5k2p7mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_s5k2p7mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
	// rDevicesInfo
	...
	static AE_CCT_CFG_T  g_rCCTConfig =
	{
		...
		150,  // u4PrvMaxFlareThres
		8,//0,  // u4PrvMinFlareThres
		...
		// rMeteringSpec
		{
			...
			// rNS_Spec
			{
				...
				168,//175,  // u4Thd
				50,//60,  // u4FlatThd
				160,//200,//180,  // u4BrightTonePcent
				45,//50,//60,  // u4BrightToneThd
				500,  // u4LowBndPcent
				3,//5,  // u4LowBndThd
				25,//30,  // u4LowBndThdLimit
