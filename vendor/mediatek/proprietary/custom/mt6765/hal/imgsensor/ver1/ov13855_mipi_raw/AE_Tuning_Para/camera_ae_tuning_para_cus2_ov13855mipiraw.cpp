...
#include "camera_ae_tuning_para_ov13855mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_ov13855mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        -22,    // i4BVOffset delta BV = value/10
        ...
        //rMeteringSpec
        {
            //rHS_Spec
            {
                ...
                166, //166,//176,//u4Thd                        // 0~255
                54, //54, //74,//u4FlatThd                    // 0~255
            ...
            //rNS_Spec
            {
               ...
               150, // 170,  //u4Thd
			    ...
			    65,        //55, //85,//	82, //  95, //u4BrightToneThd
