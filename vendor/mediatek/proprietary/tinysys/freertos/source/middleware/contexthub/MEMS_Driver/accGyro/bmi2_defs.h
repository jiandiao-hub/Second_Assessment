...
#define BMI2_AUX_IF_TRIM_ADDR                      UINT8_C(0x68)
...
#define BMI2_LP_FILTER                     UINT8_C(23)
#define BMI2_STEP_COUNTER_PARAMS           UINT8_C(24)

#define BMI2_TEMP                          UINT8_C(25)
#define BMI2_ACCEL_SELF_TEST               UINT8_C(26)
#define BMI2_GYRO_SELF_OFF                 UINT8_C(27)
#define BMI2_ACTIVITY_RECOGNITION          UINT8_C(28)
#define BMI2_MAX_BURST_LEN                 UINT8_C(29)
#define BMI2_AXIS_MAP                      UINT8_C(30)
#define BMI2_SENS_MAX_NUM                  UINT8_C(31)
#define BMI2_NVM_STATUS                    UINT8_C(32)
#define BMI2_VFRM_STATUS                   UINT8_C(33)
#define BMI2_GYRO_CROSS_SENSE              UINT8_C(34)
#define BMI2_CRT_GYRO_SELF_TEST            UINT8_C(35)
#define BMI2_ABORT_CRT_GYRO_SELF_TEST      UINT8_C(36)
#define BMI2_NVM_PROG_PREP                 UINT8_C(37)
#define BMI2_ACTIVITY_RECOGNITION_SETTINGS UINT8_C(38)
