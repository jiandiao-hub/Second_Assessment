...
static struct bh1726Task *sampleAlsDebugPoint;
                                 ...
                                 void *outBuf, uint8_t *outSize, uint8_t *elemOutSize)
{
    ...
    //osLog(LOG_INFO, "RawData0=0x%x, RawData1=0x%x\n", mTask.rawData[DATA0], mTask.rawData[DATA1]);/*lzc*/
...
{
    strncpy(data->name, "bh1726", sizeof(data->name));
}
...
static struct sensorFsm bh1726Fsm[] = {
    ...
    //sensorFsmCmd(STATE_CORE, STATE_PS_RESET, bh1726_register_core),
};
