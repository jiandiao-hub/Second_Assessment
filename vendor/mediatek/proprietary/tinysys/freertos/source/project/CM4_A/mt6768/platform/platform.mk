...
$(eval TOTAL_HEAP_SIZE=$(shell echo $$(($(TOTAL_HEAP_SIZE) + (5 * 1024)))))
endif
...
ifeq ($(CFG_SPI_FREERTOS_SUPPORT),yes)
INCLUDES += $(DRIVERS_PLATFORM_DIR)/spi_freertos/inc
C_FILES  += $(DRIVERS_PLATFORM_DIR)/spi_freertos/src/spifreertos.c
# C_FILES  += $(DRIVERS_PLATFORM_DIR)/spi_freertos/src/spi_test.c
endif
...
FEATURE_INCLUDES := \
  ...
  $(SOURCE_DIR)/middleware/lib/audio/cm4/vow/inc/mt6768 \
...
FEATURE_LIBFLAGS := \
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow/mt6768 -lblisrc_vow
...
FEATURE_LIBFLAGS := \
  ...
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow/mt6768 -lblisrc_accurate_vow \
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow/mt6768 -lblisrc_echo_ref_vow
include $(REGISTER_FEATURE)
