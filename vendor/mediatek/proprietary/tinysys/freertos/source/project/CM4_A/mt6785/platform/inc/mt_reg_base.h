...
#define P_APB_SLP_PROT_EN            (1 << 3)
#define D_APB_SLP_PROT_EN            (1 << 4)
#define P_AXI_SLP_PROT_EN            (1 << 1)
...
#define BUS_QOS                      (CFGREG_BASE + 0xE8)
    ...
    #define NO_INS_DRAM_ACC_EN  (1 << 30)
...
#define SCP_TIMER0_EN                (CFGREG_BASE + 0x3000)
    #define TIMER0_EN_SHF       0
    #define TIMER0_CLK_SRC_SHF  4
    #define TIMER0_CLK_SRC_MSK  0x3
...
#define RG_SLEEP_STATE               (CFGREG_BASE + 0x4060)
...
#define ULPOSC_CON0         (AP_BASE + 0xC700)
#define ULPOSC_CON2         (AP_BASE + 0xC708)
...
#define ULPOSC_CON1         (AP_BASE + 0xC704)
#define ULPOSC_CON3         (AP_BASE + 0xC70C)
...
#else
#define CLK_CFG_UPDATE          (TOPCK_BASE + 0x0004)
#define SCP_CK_UPDATE_SHFT      2
#define CLK_CFG_0               (TOPCK_BASE + 0x0020)
#define CLK_CFG_0_SET           (TOPCK_BASE + 0x0024)
#define CLK_CFG_0_CLR           (TOPCK_BASE + 0x0028)
    #define CLK_SCP_SEL_MSK     0x7
    #define CLK_SCP_SEL_SHFT    16
#endif

#if defined(CONFIG_MACH_MT6781)
#define CLK_MISC_CFG_0          (TOPCK_BASE + 0x0140)
#define CLK_DBG_CFG             (TOPCK_BASE + 0x017C)
#define CLK26CALI_0           (TOPCK_BASE + 0x0220)
#define CLK26CALI_1           (TOPCK_BASE + 0x0224)
#else
/* FREQUENCY METER CONTROL */
#define CLK_MISC_CFG_0          (TOPCK_BASE + 0x0110)
...
/* MDLA registers */
#define APU_COREC_MDLA_CMDE     0xA9390000
#define MREG_TOP_G_INTP0        (APU_COREC_MDLA_CMDE + 0x0504)
