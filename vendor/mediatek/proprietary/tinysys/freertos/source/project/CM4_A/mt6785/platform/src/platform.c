...
#ifdef CFG_MTK_ULTRASND_PROXIMITY
#include "ultrasound_driver.h"
#include <audio_share_irq.h>
#endif
...
#if defined(CONFIG_CONTEXTHUB_FW_SUPPORT)
...
#else
	    DRV_WriteReg32(L1C_REMAP_CFG0, ((cache_dram_addres + 0) << 16) | (0x105));
        DRV_WriteReg32(L1C_REMAP_CFG1, ((cache_dram_addres + 2) << 16) | (cache_dram_addres + 1));
#endif
