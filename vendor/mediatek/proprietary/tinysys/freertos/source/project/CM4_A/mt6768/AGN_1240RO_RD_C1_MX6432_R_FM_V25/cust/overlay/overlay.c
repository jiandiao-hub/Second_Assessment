...
ACC_GYRO_OVERLAY_REMAP_START
	...
	ACC_GYRO_OVERLAY_REMAP(stk832x);
...
ALSPS_OVERLAY_REMAP_START
    ALSPS_OVERLAY_REMAP(stk3338);
    //ALSPS_OVERLAY_REMAP(fakeAls); /*The fakeAls must be place at the end overlay list*/
...
void alspsSecondaryOverlayRemap(void)
{
    ...
    //ALSPS_SECONDARY_OVERLAY_REMAP(fakePs); /*The fakePs must be place at the end overlay list*/
