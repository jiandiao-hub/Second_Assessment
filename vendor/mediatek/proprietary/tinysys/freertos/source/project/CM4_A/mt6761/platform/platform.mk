...
CFG_MTK_TINYSYS_SCP_LOGGER_SUPPORT = yes
CFG_LOG_FILTER = no
CFG_WDT_SUPPORT = yes
CFG_DMA_SUPPORT = yes
...
ifneq ($(CFG_MTK_TINYSYS_SCP_LOGGER_SUPPORT),yes)
CFLAGS += -DLOGGER_DRAM_DISABLE=1
endif
...
CFLAGS += -DconfigTOTAL_HEAP_SIZE='( ( size_t ) ( 45 * 1024 ) )'
else ifeq ($(CFG_DEVEL_HEAP_SIZE_SUPPORT),yes)
CFLAGS += -DconfigTOTAL_HEAP_SIZE='( ( size_t ) ( 40 * 1024 ) )'
else ifeq ($(CFG_CHRE_256KB_SUPPORT),yes)
CFLAGS += -DconfigTOTAL_HEAP_SIZE='( ( size_t ) ( 37 * 1024 ) )'
...
C_FILES  += $(SOURCE_DIR)/drivers/common/cache/v01/src/cache_dram_management.c
...
FEATURE_LIBFLAGS := \
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow -lvow \
  -L$(SOURCE_DIR)/middleware/lib/audio/cm4/vow -lblisrc_vow
