...
#ifdef CFG_HEAP_MONITOR_SUPPORT
    /* heap monitor struct init*/
    tinysys_heap_monitor_init();
#endif
...
static void prvSetupHardware(void)
{
    ...
    DRV_WriteReg32(SCP_INTC_IRQ_ENABLE_MSB, 0xF7FFFFFD);
...
void vAssertCalled(char* file, uint32_t line)
{
    ...
    if (xTaskGetCurrentTaskHandle() != NULL)
        ...
        PRINTF_E("[ASSERT]file:%s,line:%lu\r\n", file, line);
