...
#define CACHE_MAGNETOMETER_TEXT \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/akl_allinone/Platform/?*.o(DRAM_TEXT_SECTIONS) \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/akl_allinone/AKM_Library/?*.a:*.o(DRAM_TEXT_SECTIONS) \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/?*.o(DRAM_TEXT_SECTIONS)\
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/memsic/?*.o(DRAM_TEXT_SECTIONS) \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/memsic/?*.a:*.o(DRAM_TEXT_SECTIONS)


#define CACHE_MAGNETOMETER_DATA \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/akl_allinone/Platform/?*.o(DRAM_DATA_SECTIONS) \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/akl_allinone/AKM_Library/?*.a:*.o(DRAM_DATA_SECTIONS) \
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/memsic/?*.o(DRAM_DATA_SECTIONS)\
    ?*/middleware/contexthub/MEMS_Driver/magnetometer/lib/memsic/?*.a:*.o(DRAM_DATA_SECTIONS)
