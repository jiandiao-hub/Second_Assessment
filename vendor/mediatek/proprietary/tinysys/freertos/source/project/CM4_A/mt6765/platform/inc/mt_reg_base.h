...
#define CLK_CTRL_GENERAL_CTRL        (CFGREG_BASE + 0x409C)
#define CLK_CTRL_SLP_CTRL            (CFGREG_BASE + 0x40A0)
    #define SLOW_CLK_WAKE_DIS_BIT    0
    #define SLOW_CLK_WAKE_DIS_MASK   0x1
    #define DIS_RAM_CK_CS_ISO    6
    #define SLOW_CLK_WAKE_INTERLEAVE_DIS_BIT 24
...
/* ULPOSC Registers */
#define ULPOSC1_CON0                (AP_BASE + 0xC2B0)
#define RG_OSC1_CALI_BIT        0
#define RG_OSC1_CALI_MSK        0x7f
#define RG_OSC1_IBAND_BIT       7
#define RG_OSC1_IBAND_MSK       0x7f
#define RG_OSC1_FBAND_BIT       14
#define RG_OSC1_FBAND_MSK       0xf
#define RG_OSC1_DIV_BIT         18
#define RG_OSC1_DIV_MSK         0x3f
#define RG_OSC1_CP_EN_BIT       24
#define RG_OSC1_CP_EN_MSK       0x1

#define ULPOSC1_CON1                (AP_BASE + 0xC2B4)
#define RG_OSC1_RSV_BIT         0
#define RG_OSC1_RSV_MSK         0xff
#define RG_OSC1_MOD_BIT         8
#define RG_OSC1_MOD_MSK         0x3
#define RG_OSC1_DIV2_EN_BIT     10
#define RG_OSC1_DIV2_EN_MSK     0x1
#define RG_OSC1_CALMOS_BIT      11
#define RG_OSC1_CALMOS_MSK      0x7
#define RG_OSC1_CALTAP_BIT      14
#define RG_OSC1_CALTAP_MSK      0x3

#define ULPOSC2_CON0                (AP_BASE + 0xC2C0)
#define RG_OSC2_CALI_BIT        0
#define RG_OSC2_CALI_MSK        0x7f
#define RG_OSC2_IBAND_BIT       7
#define RG_OSC2_IBAND_MSK       0x7f
#define RG_OSC2_FBAND_BIT       14
#define RG_OSC2_FBAND_MSK       0xf
#define RG_OSC2_DIV_BIT         18
#define RG_OSC2_DIV_MSK         0x3f
#define RG_OSC2_CP_EN_BIT       24
#define RG_OSC2_CP_EN_MSK       0x1

#define ULPOSC2_CON1                (AP_BASE + 0xC2C4)
#define RG_OSC2_RSV_BIT         0
#define RG_OSC2_RSV_MSK         0xff
#define RG_OSC2_MOD_BIT         8
#define RG_OSC2_MOD_MSK         0x3
#define RG_OSC2_DIV2_EN_BIT     10
#define RG_OSC2_DIV2_EN_MSK     0x1
#define RG_OSC2_CALMOS_BIT      11
#define RG_OSC2_CALMOS_MSK      0x7
#define RG_OSC2_CALTAP_BIT      14
#define RG_OSC2_CALTAP_MSK      0x3

/* SCP PLL MUX RG */
#define CLK_CFG_UPDATE          (TOPCK_BASE + 0x0004)
#define SCP_CK_UPDATE_BIT   3
#define CLK_CFG_0               (TOPCK_BASE + 0x0040)
#define CLK_CFG_0_SET           (TOPCK_BASE + 0x0044)
#define CLK_CFG_0_CLR           (TOPCK_BASE + 0x0048)
#define CLK_SCP_SEL_BIT     24
