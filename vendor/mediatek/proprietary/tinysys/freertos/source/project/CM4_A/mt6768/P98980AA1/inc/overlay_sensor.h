...
#define OVERLAY_TWO_LIB_OBJECT(tag, lib1, lib2, file1, file2) \
        .tag { lib1.a: file1.o OVERLAY_SECTION_TEXT } \
        .tag { lib2.a: file2.o OVERLAY_SECTION_TEXT }

/*****************************************************************************
* Overlay0: ACCGYRO
*****************************************************************************/
#define OVERLAY_SECTION_ACCGYRO                    \
    OVERLAY_ONE_OBJECT(bmi2xy, bmi2xy) \
...
#define OVERLAY_SECTION_ALSPS                      \
    OVERLAY_ONE_OBJECT(stk3321, stk3321)           \
    OVERLAY_ONE_OBJECT(fakeAls, fakeAls)
...
#define OVERLAY_SECTION_ALSPS_SECONDARY           \
    OVERLAY_ONE_OBJECT(fakePs, fakePs)
...
#define OVERLAY_SECTION_SAR                       \
    OVERLAY_ONE_OBJECT(aw9610x,aw9610x)          \
    OVERLAY_ONE_OBJECT(hx9031a, hx9031a)
