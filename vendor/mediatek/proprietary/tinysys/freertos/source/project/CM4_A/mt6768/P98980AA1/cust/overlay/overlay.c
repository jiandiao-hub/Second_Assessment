...
#define SAR_OVERLAY_REMAP_START
#define SAR_OVERLAY_REMAP_END sarEnd:
#define SAR_OVERLAY_REMAP(name) SENSOR_OVERLAY_REMAP(name, sarEnd)
...
void sarOverlayRemap(void)
{SAR_OVERLAY_REMAP_START
SAR_OVERLAY_REMAP(aw9610x);
SAR_OVERLAY_REMAP(hx9031a);
SAR_OVERLAY_REMAP_END
return;}
/******************************************************************************
******************************************************************************/
...
ALSPS_OVERLAY_REMAP_START
    ...
    ALSPS_OVERLAY_REMAP(fakeAls); /*must be place at the end overlay list*/
...
ALSPS_SECONDARY_OVERLAY_REMAP_START
    ALSPS_SECONDARY_OVERLAY_REMAP(fakePs); /*must be place at the end overlay list*/
