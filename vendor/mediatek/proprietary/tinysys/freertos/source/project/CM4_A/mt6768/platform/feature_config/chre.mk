...
ifeq ($(CFG_STK3338_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/alsps/stk3338.c
endif
endif
...
ifeq ($(CFG_SAR_AW9610X_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/sar/aw9610x.c
endif
ifeq ($(CFG_HX9031A_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/sar/hx9031a.c
endif
...
ifeq ($(CFG_BMI2XY_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/accGyro/bmi2xy.c
endif
ifeq ($(CFG_ICM4N607_SUPPORT),yes)
