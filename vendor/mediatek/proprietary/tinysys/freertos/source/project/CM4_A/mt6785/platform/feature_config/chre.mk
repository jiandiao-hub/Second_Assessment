...
C_FILES  += $(SOURCE_DIR)/middleware/contexthub/sensorPower.c
endif
...
ifeq ($(CFG_VC36658_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/alsps/vc36658.c
endif
ifeq ($(CFG_LTR578_SUPPORT),yes)
ifneq ($(wildcard $(PRIVATE_SENDRV_DIR)),)
C_FILES  += $(PRIVATE_SENDRV_DIR)/alsps/ltr578.c
INCLUDES += -I$(PRIVATE_SENDRV_DIR)/alsps/
endif
endif
...
ifeq ($(CFG_TMF8801_SUPPORT),yes)
ifneq ($(wildcard $(PRIVATE_SENDRV_DIR)),)
C_FILES  += $(PRIVATE_SENDRV_DIR)/alsps/tmf8801.c
INCLUDES += -I$(PRIVATE_SENDRV_DIR)/alsps/
endif
endif
endif
...
ifeq ($(CFG_BMP380_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/barometer/bosch_bmp380.c
endif
endif
...
ifeq ($(CFG_ADUX1050_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/sar/adux1050.c
endif
endif
...
ifeq ($(CFG_AKM09919_SUPPORT),yes)
CFG_AKM_VENDOR_SUPPORT = yes
C_FILES  += $(SENDRV_DIR)/magnetometer/akm09919.c
endif
...
ifeq ($(CFG_MEMSIC_TINY_FUSION_SUPPORT),yes)
C_FILES += $(SENLIB_DIR)/memsic_tinylib/memsic_wrapper.c
INCLUDES += -I$(SENLIB_DIR)/memsic_tinylib/
LIBFLAGS += -L$(SENLIB_DIR)/memsic_tinylib -lMemsicAlgo
endif
endif
...
ifeq ($(CFG_MTK_CALIBRATION_V1_0),yes)
INCLUDES += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos
C_FILES  += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos/calibration/gyroscope/gyro_cal.c
C_FILES  += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos/calibration/gyroscope/gyro_stillness_detect.c
C_FILES  += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos/calibration/over_temp/over_temp_cal.c
C_FILES  += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos/calibration/sample_rate_estimator/sample_rate_estimator.c
C_FILES  += $(SOURCE_DIR)/../../../hardware/contexthub/firmware/src/algos/calibration/factory_calibration/factory_cal.c
else
...
ifeq ($(CFG_LSM6DSO_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/accGyro/lsm6dsoxx.c
endif
ifeq ($(CFG_LSM6DSM_I2C_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/accGyro/lsm6dsm_i2c.c
endif
...
ifeq ($(CFG_BMI220_SUPPORT),yes)
ifneq ($(wildcard $(PRIVATE_SENDRV_DIR)),)
C_FILES  += $(PRIVATE_SENDRV_DIR)/accgyro/bmi2xy.c
INCLUDES += -I$(PRIVATE_SENDRV_DIR)/accgyro/
endif
endif
endif

ifeq ($(CFG_LSM6DSM_VGYRO_SUPPORT), yes)
C_FILES  += $(SOURCE_DIR)/../secure/middleware/vgyro_test/lsm6dsm.c
endif
...
INCLUDES += -I$(SOURCE_DIR)/drivers/common/uSnd
endif
