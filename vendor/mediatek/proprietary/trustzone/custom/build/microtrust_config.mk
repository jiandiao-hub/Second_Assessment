...
# Android.bp will be in /vendor/bin/thh/ta and will change architecture in huge.
...
MICROTRUST_ORI_IMAGE_NAME := $(MTK_PATH_SOURCE)/trustzone/microtrust/source/common/lite/mt6580/teei/teei.raw
else
MICROTRUST_ORI_IMAGE_NAME := $(MTK_PATH_SOURCE)/trustzone/microtrust/source/common/lite/teei/teei.raw
endif
$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei/isee_product.cfg $(TARGET_OUT_VENDOR)/thh/ta/isee_product.cfg)
$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei/TAs_list $(TARGET_OUT_VENDOR)/thh/ta/TAs_list)
$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei_loader $(TARGET_OUT_VENDOR)/bin/teei_loader)
$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei_loader/microtrust.rc $(TARGET_OUT_VENDOR)/etc/init/microtrust.rc)

#$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/lite/init_thh/init_thh_lite $(TARGET_OUT_VENDOR)/bin/init_thh)
#$(shell cp -f vendor/mediatek/proprietary/trustzone/microtrust/source/common/lite/init_thh/microtrust.init_thh.rc $(TARGET_OUT_VENDOR)/etc/init/microtrust.init_thh.rc)

else
MICROTRUST_ORI_IMAGE_NAME := $(MTK_PATH_SOURCE)/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei/teei.raw
ifeq ($(strip $(MICROTRUST_THH_SUPPORT)), yes)
$(shell cp -f $(MTK_PATH_SOURCE)/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei/uTAgent $(TARGET_OUT_VENDOR)/thh/ta/0102030405060708090a0b0c0d0e0f10.ta)
endif
...
$(shell cp -f $(MTK_PATH_SOURCE)/trustzone/microtrust/source/common/$(MICROTRUST_TEE_VERSION)/teei/93feffccd8ca11e796c7c7a21acb4932.ta $(TARGET_OUT_VENDOR)/thh/ta/93feffccd8ca11e796c7c7a21acb4932.ta)
