...
#define MT65XX_FACTORY_KEY    17//(kpd_dts_data.kpd_hw_factory_key)
#define MT65XX_RECOVERY_KEY   0//(kpd_dts_data.kpd_hw_recovery_key)
#define MTK_PMIC_PWR_KEY      (kpd_dts_data.kpd_hw_pwrkey)
#define MTK_PMIC_RST_KEY      17//(kpd_dts_data.kpd_hw_rstkey)
#endif
