...
MTK_MT6362_PMU_CHARGER_SUPPORT := no
MTK_MT6362_SUPPORT := no
MTK_MT6360_PMU_CHARGER_SUPPORT := yes
TYPEC_MT6360 = yes
MTK_5G_B_MT6360_MT6315 := yes
MTK_LCM_PHYSICAL_ROTATION = 0
CUSTOM_LK_LCM="td4330_fhdp_dsi_vdo_auo_rt5081 nt36672a_fhdp_dsi_vdo_auo_rt4801 nt35695B_fhd_dsi_vdo_auo_rt4801"
#nt35595_fhd_dsi_cmd_truly_nt50358 = yes
MTK_VERIFIED_BOOT_SUPPORT = no
MTK_SEC_FASTBOOT_UNLOCK_SUPPORT = yes
SPM_FW_USE_PARTITION = yes
BOOT_LOGO := fhd fhdplus2280
DEBUG := 2
...
MTK_SW_EFUSE_BONDING_DISPLAY = 0x1
MTK_SW_EFUSE_BONDING_CAMERA = 0x1
# use mblock allocated memory instead of system heap
HEAP_USE_MBLOCK = yes
