...
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.sf.lcd_density=230
...
ifeq ($(strip $(MTK_AB_OTA_UPDATER)),yes)
  PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(MTK_BASE_PROJECT)/vendor/etc/fstab.mt6765:$(TARGET_COPY_OUT_RECOVERY)/root/first_stage_ramdisk/fstab.mt6762
else
  PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(MTK_BASE_PROJECT)/vendor/etc/fstab.mt6765:$(TARGET_COPY_OUT_RAMDISK)/fstab.mt6762
endif
...
# mem3630x lib64
ifeq ($(AGENEW_MEM3630_SUPPORT),yes)
	PRODUCT_COPY_FILES += device/mediatek/common/prebuilts/mmc3630lib64/libmemsic.so:vendor/lib64/libmemsic.so
endif
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/AGN_H231UO_M119_62S/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/AGN_H231UO_M119_62S/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/AGN_H231UO_M119_62S/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/AGN_H231UO_M119_62S/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/AGN_H231UO_M119_62S/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk
